...
static void hnd_espressif_get(coap_context_t *ctx, coap_resource_t *resource,
		...
		coap_string_t *query, coap_pdu_t *response)
{
	...
	ESP_LOGI("COAP", "Received GET request");
}
...
static void hnd_espressif_delete(coap_context_t *ctx,
		coap_resource_t *resource,
		coap_session_t *session,
		coap_pdu_t *request,
		coap_binary_t *token,
